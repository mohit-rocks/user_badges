...
/**
 * @file
 * Contains \Drupal\user_badges\BadgeTypeHtmlRouteProvider.
 */
...
/**
 * Provides routes for Badge type entities.
 *
 * @see Drupal\Core\Entity\Routing\AdminHtmlRouteProvider
 * @see Drupal\Core\Entity\Routing\DefaultHtmlRouteProvider
 */
class BadgeTypeHtmlRouteProvider extends AdminHtmlRouteProvider {
  /**
   * {@inheritdoc}
   */
